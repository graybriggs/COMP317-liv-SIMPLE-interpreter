...
Scanner.prototype.getAtom = function(syntax, pos) {
...
Scanner.prototype.isInteger = function(syntax) {
...
Scanner.prototype.isReal = function(syntax) {
...
Scanner.prototype.isKeyword = function(syntax) {
...
Scanner.prototype.isIdentifier = function(syntax) {
...
Scanner.prototype.isAssignmentOperator = function(syntax) {
...
Scanner.prototype.isEquivalenceOperator = function(syntax) {
    if (syntax[0] === '=' && syntax[1] === '=')
        return true;
    else
        return false;
...
Scanner.prototype.isGreaterThanOperator = function(syntax) {
    if (syntax[0] === '>')
        return true;
    else
        return false;
...
Scanner.prototype.isLessThanOperator = function(syntax) {
    if (syntax[0] === '<')
        return true;
    else
        return false;
...
Scanner.prototype.isGreaterThanEqualToOperator = function(syntax) {
    if (syntax[0] === '>' && syntax[1] === '=')
        return true;
    else
        return false;
...
Scanner.prototype.isLessThanEqualToOperator = function(syntax) {
    if (syntax[0] === '<' && syntax[1] === '=')
        return true;
    else
        return false;
